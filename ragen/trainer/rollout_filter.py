...
class RolloutFilter:
    ...
    def _build_base_metrics(
        ...
        metrics.update(
            {
                "rollout/chosen_in_group_std": self._selected_mean(in_group_std, top_groups),
                "rollout/chosen_in_group_max": self._selected_mean(in_group_max, top_groups),
                "rollout/chosen_in_group_mean": self._selected_mean(in_group_mean, top_groups),
            }
        )
        return metrics
