# Experiment: Gradient Analysis on Frozen Lake (100% success rate)
...
python3 train.py --config-name "_3_frozen_lake" \
    trainer.project_name='AGEN_gradient_analysis' \
    trainer.experiment_name='gradient_analysis_frozen_lake_3b' \
