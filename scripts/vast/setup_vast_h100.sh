#!/bin/bash
# Setup script for Vast.ai H100/A100 (Hopper/Ampere sm_90 and below) machines
# Search benchmark only. For B200/B100 use setup_vast_b200.sh instead.
#
# Installs: conda env, PyTorch 2.5 (cu124), flash-attn 2.7.4, vllm 0.8.2,
...
# ---------- Done ----------
echo ""
print_ok "Setup complete! (H100/A100)"
